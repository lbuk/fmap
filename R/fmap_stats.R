...
#'
#' Function for calculating summary statistics from Fresnel Maps, or thematic maps that visualise geospatial data to the level of equal-area concentric circles.
#'
